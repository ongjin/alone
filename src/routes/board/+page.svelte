    ...
    <div class="row">
            ...
            <div class="card bg-pattern">
                <div class="card-body">
                    <div class="float-right">
                        <i class="fa fa-archive text-primary h4 ml-3" />
                    </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-pattern">
                <div class="card-body">
                    <div class="float-right">
                        <i class="fa fa-th text-primary h4 ml-3" />
                    </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-pattern">
                <div class="card-body">
                    <div class="float-right">
                        <i class="fa fa-file text-primary h4 ml-3" />
                    </div>
                            ...
                            <div class="input-group mb-0">
                                ...
                                <div class="input-group-append">
                                    <button
                                        ...
                                        ><i
                                            class="fa fa-search search-icon font-12"
                                        /></button
                                    >
                                </div>
                            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive project-list">
                        <table
                            class="table project-table table-centered table-nowrap"
                        >
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="text-success font-12"
                                            ><i
                                                class="mdi mdi-checkbox-blank-circle mr-1"
                                            /> Completed</span
                                        >
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <p class="mb-0">
                                            Progress<span class="float-right"
                                                >100%</span
                                            >
                                        </p>
                    ...
                    <div class="pt-3">
                        <ul class="pagination justify-content-end mb-0">
                            ...
                            <li class="page-item">
                                ...
                                <a class="page-link {pageNo == 1 ? 'active' : ''}" on:click={() => {goPage(`/board/1`)}}>1</a>
                            </li>
                            <!-- active -->
                            <li class="page-item">
                                <!-- svelte-ignore a11y-click-events-have-key-events -->
                                <!-- svelte-ignore a11y-missing-attribute -->
                                <a class="page-link {pageNo == 2 ? 'active' : ''}" on:click={() => {goPage(`/board/2`)}}>2</a>
                            </li>
                            <li class="page-item">
                                <!-- svelte-ignore a11y-click-events-have-key-events -->
                                <!-- svelte-ignore a11y-missing-attribute -->
                                <a class="page-link {pageNo == 3 ? 'active' : ''}" on:click={() => {goPage(`/board/3`)}}>3</a>
                            </li>
                            <li class="page-item">
                                <!-- svelte-ignore a11y-missing-attribute -->
